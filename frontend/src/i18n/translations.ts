...
export const translations = {
  no: {
    ...
    'dashboard.deleteConfirm': 'Er du sikker på at du vil slette kanalen «{name}»? Dette kan ikke angres.',
    ...
    'speak.hint': 'Gi kanalkoden til lyttere.',
    ...
    'help.sections': [
      ...
      },
      {
        ...
        innhold: [
          ...
          'Hvis mikrofonen ikke virker i nettleseren, sjekk at du har gitt tillatelse under nettleserinnstillinger.',
        ],
      },
    ],
  ...
  en: {
    ...
    'dashboard.deleteConfirm': 'Are you sure you want to delete the channel "{name}"? This cannot be undone.',
    ...
    'speak.hint': 'Share the channel code with listeners.',
    ...
    'help.sections': [
      ...
      },
      {
        ...
        innhold: [
          ...
          'If the microphone does not work in the browser, check that you have granted permission in your browser settings.',
        ],
      },
    ],
