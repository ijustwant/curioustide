...
export const translations = {
  no: {
    ...
    'speak.clipDeleteTitle': 'Slett intervju',
    'speak.clipDeleteConfirm': 'Er du sikker på at du vil slette «{name}»? Dette kan ikke angres.',
  ...
  en: {
    ...
    'speak.clipDeleteTitle': 'Delete interview',
    'speak.clipDeleteConfirm': 'Are you sure you want to delete "{name}"? This cannot be undone.',
